...
//finder tool will be available at home of autoit only     // we required two things they are autoit script editor and autoit to be install
// above code is written in  auto it script editor
...
WebDriver driver;
	...
	//FOR THIS SIKULI WE NEED SIKULI JARS WHICH ARE AVAILABLE IN MVN REPOSITORY AND WE REQUIRED SIKULI SETUP TO BE INSTALLED .BY USING SNIPPING TOOL WE CAN CROP THE IMAGE.
        ...
        GO TO START-ALL PROGRAMS-ACCESSORIES-SNIPPING TOOL-CLICK NEW-CROP SOMETHING WHICH IS USEFULL-SAVE IN A FOLDERON DESKTOP.
         ...
         \\SIKULI IS USED TO FIND THE NON WEBELEMENTS ,   AND WITHOUT USING THE LOCATORs AND IF WE DIDNT FOUND LOCATORS OF A WEBELEMENTS IN A APP ,AND DYNAMICALLY CHANGING X-PATHS ,
